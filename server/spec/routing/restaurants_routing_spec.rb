...
RSpec.describe RestaurantsController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #update via PUT' do
      expect(put: '/restaurants/1').to
      route_to('restaurants#update', id: '1')
    end

    it 'routes to #update via PATCH' do
      expect(patch: '/restaurants/1').to
      route_to('restaurants#update', id: '1')
    end

    it 'routes to #destroy' do
      expect(delete: '/restaurants/1').to
      route_to('restaurants#destroy', id: '1')
    end
  end
end
